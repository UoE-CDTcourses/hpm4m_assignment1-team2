...
// MPI implementation of problem with rectangular sub-division.
...
int main (){
  ...
  // Approximate integral using Nmax = 2^15
    ...
    double x0 = round(rank*n/size)*dx, x1 = round((rank+1)*n/size)*dx, y0 = 0, y1 = b;  // Split grid into rectangles
    double integral = 0;
